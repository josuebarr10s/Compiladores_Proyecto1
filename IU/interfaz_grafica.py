...
from Analizadores.analizador_lexico import analizar_lexico, PALABRAS_RESERVADAS
...
class AnalizadorApp(QMainWindow):
    def __init__(self):
        ...
        _icon_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "logo-pedidos.png")
    ...
    def _make_title_bar(self):
        ...
        lay.setSpacing(0)
        logo_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "Iconos", "logo-pedidos.png")
        logo_label = QLabel()
